    ...
    public class PhoneDetailPageModel : BasePageModel
    {
        ...
        private async Task LoadData()
        {
            ...
            else
            {
                ...
                imageRequest.Product_Id = Product.ProductId;
                var data3 = await _productSKUService.GetProductImages(imageRequest);
                Images = data3;
        ...
        public ProductSKURequest imageRequest { get; set; } = new ProductSKURequest();
        public List<RatingModel> Ratings { get; set; } = new List<RatingModel>();
        public List<ImgModel> Images { get; set; } = new List<ImgModel>();
