...
namespace Phoenix.Mobile.Core.Services.Common
{
    public interface IProductSKUService
    {
        ...
        Task<List<ImgModel>> GetProductImages(ProductSKURequest request);
    }
    ...
    public class ProductSKUService : IProductSKUService
    {
        ...
        public async Task<List<ImgModel>> GetProductImages(ProductSKURequest request)
        {
            var productSKU = await _productSKUProxy.GetProductImages(request);
            return productSKU.Data.MapTo<ImgModel>();
        }
    }
}
