...
namespace Phoenix.Mobile.Core.Services.Common
{
    public interface IUserService
    {
        ...
        Task<List<UserModel>> GetAllUsers(UserRequest request);
    }
    ...
    public class UserService : IUserService
    {
        ...
        public async Task<List<UserModel>> GetAllUsers(UserRequest request)
        {
            var productMenu = await _userProxy.GetAllUsers(request);
            return productMenu.Data.MapTo<UserModel>();
        }
    }
}
