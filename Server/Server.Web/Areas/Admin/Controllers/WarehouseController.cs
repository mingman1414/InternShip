...
namespace Phoenix.Server.Web.Areas.Admin.Controllers
{
    public class WarehouseController : BaseController
    {
        ...
        public async Task<ActionResult> Create(WarehouseModel model)
        {
            ...
            if (!res.Success)
            {
                ErrorNotification("Thêm mới số lượng không thành công");
                return View(model);
            }
            SuccessNotification("Thêm mới số lượng thành công");
        ...
        public async Task<ActionResult> Update(WarehouseModel model)
        {
            ...
            SuccessNotification("Chỉnh sửa số lượng thành công");
        ...
        public async Task<ActionResult> Delete(int id)
        {
            ...
            SuccessNotification("Đã số lượng thành công");
