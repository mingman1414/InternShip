...
namespace Phoenix.Server.Web.Areas.Admin.Controllers
{
    public class ProductTypeController : BaseController
    {
        ...
        public async Task<ActionResult> Create(ProductTypeModel model)
        {
            ...
            {
                ErrorNotification("Thêm mới loại sản phẩm không thành công");
                return View(model);
            }
            SuccessNotification("Thêm mới loại sản phẩm thành công");
        ...
        public async Task<ActionResult> Update(ProductTypeModel model)
        {
            ...
            SuccessNotification("Chỉnh sửa thông tin loại sản phẩm thành công");
