...
namespace Phoenix.Server.Web.Areas.Admin.Controllers
{
    public class ProductController : BaseController
    {
        ...
        { 
            ...
            if (!res.Success)
            {
                ErrorNotification("Thêm mới sản phẩm không thành công");
                return View(model);
            }
            SuccessNotification("Thêm mới sản phẩm thành công");
        ...
        public async Task<ActionResult> Update(ProductModel model)
        {
            ...
            SuccessNotification("Chỉnh sửa thông tin sản phẩm thành công");
