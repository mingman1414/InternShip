...
namespace Phoenix.Server.Web.Areas.Admin.Controllers
{
    public class ProductSKUController : BaseController
    {
        ...
        public async Task<ActionResult> Create(ProductSKUModel model)
        {
            ...
            {
                ErrorNotification("Thêm mới chi tiết sản phẩm không thành công");
                return View(model);
            }
            SuccessNotification("Thêm mới chi tiết sản phẩm thành công");
        ...
        public async Task<ActionResult> Update(ProductSKUModel model)
        {
            ...
            SuccessNotification("Chỉnh sửa thông tin chi tiết sản phẩm thành công");
        ...
        public async Task<ActionResult> Delete(int id)
        {
            ...
            SuccessNotification("Xóa chi tiết sản phẩm thành công");
